...
public class ObjectResolver extends Resolver
{
        ...
        try
        {
            ...
            else if (rhs instanceof JsonObject)
            {
                ...
                {    // Assign ObjectMap's to Object (or derived) fields
                    ...
                    if (!LogicalPrimitives.isLogicalPrimitive(jsRhs.getTargetClass()))
                    {
            ...
            {
                if (LogicalPrimitives.isPrimitive(fieldType))
                {
            ...
            else if (rhs instanceof JsonObject)
            {
                ...
                {   // Assign ObjectMap's to Object (or derived) fields
                    ...
                    if (jObj.getType() != null)
                    {
                        ...
                        if (!LogicalPrimitives.isLogicalPrimitive(jObj.getTargetClass()))
                        {
    ...
    protected void traverseArray(final Deque<JsonObject> stack, final JsonObject jsonObj)
    {
        ...
        final boolean isPrimitive = LogicalPrimitives.isPrimitive(compType);
        ...
        for (int i=0; i < len; i++)
        {
            ...
            else if (element instanceof JsonObject)
            {
                ...
                {    // Convert JSON HashMap to Java Object instance and assign values
                    ...
                    Array.set(array, i, arrayElement);
                    if (!LogicalPrimitives.isLogicalPrimitive(arrayElement.getClass()))
