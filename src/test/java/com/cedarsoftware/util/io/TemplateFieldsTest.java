...
public class TemplateFieldsTest
{
    ...
    public void testSingle()
    {
        ...
        UseSingle other = TestUtil.toJava(json);
    ...
    public void testTwoParam()
    {
        ...
        UseTwoParam other = TestUtil.toJava(json);
    ...
    public void testStaticSingle()
    {
        ...
        StaticUseSingle other = TestUtil.toJava(json);
    ...
    public void test3TypeGeneric()
    {
        ...
        GenericHolder gen = TestUtil.toJava(json);
