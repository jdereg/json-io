...
class AtomicLongTest
{
    ...
    void testAssignAtomicLong()
    {
        ...
        assert json.equals("{\"@type\":\"com.cedarsoftware.util.io.AtomicLongTest$TestAtomicLongField\",\"value\":16,\"nullValue\":null,\"strValue\":50,\"emptyStrValue\":0,\"objValue\":-9,\"values\":[-5,null,5,45]}");
