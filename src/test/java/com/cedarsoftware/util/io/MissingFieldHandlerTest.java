...
public class MissingFieldHandlerTest
{
    ...
    public void testMissingHandler()
    {
        ...
        assert !madeItHere[0];
        CustomPoint clonePoint = TestUtil.toJava(OLD_CUSTOM_POINT, new ReadOptionsBuilder().setMissingFieldHandler(missingHandler).build());
        assert madeItHere[0];
    ...
    private static final String OLD_CUSTOM_POINT = "{\"@type\":\"com.cedarsoftware.util.io.MissingFieldHandlerTest$CustomPoint\",\"x\":5,\"y\":7}";
    private static final String OLD_CUSTOM_POINT2 = "{\"@type\":\"com.cedarsoftware.util.io.MissingFieldHandlerTest$CustomPointWithRef\",\"inner1\":{\"@id\":1},\"inner2\":{\"@type\":\"com.cedarsoftware.util.io.MissingFieldHandlerTest$CustomPointWithRef$Inner2\",\"inner12\":{\"@ref\":1}},\"b\":true,\"bb\":true,\"by\":9,\"bby\":9,\"c\":\"9\",\"cc\":\"9\",\"d\":9.0,\"dd\":9.0,\"f\":9.0,\"ff\":9.0,\"i\":9,\"ii\":9,\"l\":9,\"ll\":9,\"s\":9,\"ss\":9,\"aStringArray\":[\"foo\",\"bar\"],\"inner2WithNoSerializedType\":{\"inner12\":null}}";
