...
public interface WriteOptions {
     ...
     * instead of the {@code @keys}/{@code @items} parallel-array format.  This produces standard JSON output that matches
     ...
     * {@code @keys}/{@code @items}.  Default is false for JSON (backward compatibility), true for JSON5.
     */
