 ...
 * 2.8.0
  * Performance optimizations (more usage of final, skip traversal of logical primitives).
  * Moved from using LinkedList to Deque (since json-io requires Java 1.7 now) for stacks.
 * 2.7.6
