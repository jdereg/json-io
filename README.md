...
**Gradle**
```groovy
implementation 'com.cedarsoftware:json-io:4.111.0'
```
...
| Read `toMaps` (class-independent) | 1.32x | 1.59x | 1.38x |
| Write `cycleSupport=true` (default) | 1.57x | 1.36x | 2.12x |
| Write `cycleSupport=false` (DTOs/acyclic) | 1.40x | 1.24x | 2.12x |
