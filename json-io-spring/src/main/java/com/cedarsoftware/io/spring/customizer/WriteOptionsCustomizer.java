...
/**
 * Callback interface for customizing json-io WriteOptions.
 * <p>
 * Implement this interface and register as a Spring bean to customize
 * how json-io writes/serializes JSON:
 * </p>
 * <pre>
 * {@literal @}Bean
 ...
 *         .prettyPrint(true)
 *         .addCustomWriter(MyClass.class, new MyCustomWriter());
 * }
 * </pre>
 * <p>
 ...
 */
@FunctionalInterface
public interface WriteOptionsCustomizer {

    /**
     * Customize the WriteOptionsBuilder.
     *
     * @param builder the builder to customize
     */
    void customize(WriteOptionsBuilder builder);
}
